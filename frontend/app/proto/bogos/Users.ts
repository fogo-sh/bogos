...
import type { GetCurrentUserRequest as _bogos_GetCurrentUserRequest, GetCurrentUserRequest__Output as _bogos_GetCurrentUserRequest__Output } from '../bogos/GetCurrentUserRequest';
...
export interface UsersClient extends grpc.Client {
  GetCurrentUser(argument: _bogos_GetCurrentUserRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  GetCurrentUser(argument: _bogos_GetCurrentUserRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  GetCurrentUser(argument: _bogos_GetCurrentUserRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  GetCurrentUser(argument: _bogos_GetCurrentUserRequest, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  getCurrentUser(argument: _bogos_GetCurrentUserRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  getCurrentUser(argument: _bogos_GetCurrentUserRequest, metadata: grpc.Metadata, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  getCurrentUser(argument: _bogos_GetCurrentUserRequest, options: grpc.CallOptions, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
  getCurrentUser(argument: _bogos_GetCurrentUserRequest, callback: grpc.requestCallback<_bogos_User__Output>): grpc.ClientUnaryCall;
...
export interface UsersHandlers extends grpc.UntypedServiceImplementation {
  GetCurrentUser: grpc.handleUnaryCall<_bogos_GetCurrentUserRequest__Output, _bogos_User>;
...
export interface UsersDefinition extends grpc.ServiceDefinition {
  GetCurrentUser: MethodDefinition<_bogos_GetCurrentUserRequest, _bogos_User, _bogos_GetCurrentUserRequest__Output, _bogos_User__Output>
